- A programming language is considered low-level if it provides little or no abstraction from a machine's internal architecture. Code is very similar to writing actual machine instructions.
