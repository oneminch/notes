...
- A Docker _Image_ is a read-only template created by processing the instructions in a `Dockerfile`.
...
- A _container_ is a runnable instance of a Docker image.
...
- _Docker Hub_ is a cloud-based registry where you can find and share Docker images.
...
- _Volumes_ are used to share files or data between containers.
