...
- **Mount**
    ...
    - It's performed as a reactive effect, therefore it _tracks_ of all reactive dependencies that were used.
...
app.component(
	"MyButton",
	defineAsyncComponent(() => import("./components/Button.vue")),
);
```
