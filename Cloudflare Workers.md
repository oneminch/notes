...
> [!note]
> Workers do not allow I/O from outside a _request context_. While environment variables and secrets can be accessed in top-level scope, calling methods on Durable Object stubs, making KV calls, or calling other Workers will not work.

### Durable Objects

- Provides _shared state_ in Workers' stateless architecture.
